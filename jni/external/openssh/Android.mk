...
LOCAL_C_INCLUDES := external/.. external/openssl/include external/zlib
...
LOCAL_SHARED_LIBRARIES += libssh libssl libcrypto libdl libcutils

LOCAL_LDLIBS := -lz

# NDK temporarily exclude because don't have cutils/properties.h
# include $(BUILD_EXECUTABLE)
